...
func GenericTest(t *testing.T, part string, nclients int, nservers int,
	...
	for i := 0; i < 3; i++ {
		// log.Printf("Iteration %v, total clients %v\n", i, nclients)
...
func TestBasic3A(t *testing.T) {
	// Test: one client (3A) ...
	GenericTest(t, "3A", 1, 5, false, false, false, -1, false, 5*time.Second)
}
...
func TestConcurrent3A(t *testing.T) {
	...
	GenericTest(t, "3A", 5, 5, false, false, false, -1, false, 5*time.Second)
}

func TestBasicLinearizable3A(t *testing.T) {
	GenericTest(t, "3A", 5, 5, false, false, false, -1, true, 5*time.Second)
}

func TestUnreliable3A(t *testing.T) {
	// Test: unreliable net, many clients (3A) ...
	GenericTest(t, "3A", 5, 5, true, false, false, -1, false, 5*time.Second)
}

func TestBasicUnreliableLinearizable3A(t *testing.T) {
	// Test: unreliable net, many clients, random keys (3A) ...
	GenericTest(t, "3A", 5, 5, true, false, false, -1, true, 5*time.Second)
}
...
func TestPersistPartitionUnreliableLinearizable3A(t *testing.T) {
	...
	GenericTest(t, "3A", 15, 7, true, true, true, -1, true, 5*time.Second)
}
...
func TestSnapshotRecover3B(t *testing.T) {
	...
	GenericTest(t, "3B", 1, 5, false, true, false, 1000, false, 5*time.Second)
}
...
func TestSnapshotUnreliable3B(t *testing.T) {
	...
	GenericTest(t, "3B", 5, 5, true, false, false, 1000, false, 5*time.Second)
}

func TestSnapshotUnreliableRecover3B(t *testing.T) {
	// Test: unreliable net, restarts, snapshots, many clients (3B) ...
	GenericTest(t, "3B", 5, 5, true, true, false, 1000, false, 5*time.Second)
}

func TestSnapshotUnreliableRecoverConcurrentPartition3B(t *testing.T) {
	// Test: unreliable net, restarts, partitions, snapshots, many clients (3B) ...
	GenericTest(t, "3B", 5, 5, true, true, true, 1000, false, 5*time.Second)
}

func TestSnapshotUnreliableRecoverConcurrentPartitionLinearizable3B(t *testing.T) {
	// Test: unreliable net, restarts, partitions, snapshots, random keys, many clients (3B) ...
	GenericTest(t, "3B", 15, 7, true, true, true, 1000, true, 5*time.Second)
}
